...
// setup view vars
static CGFloat sDROPVIEW_MARGIN = 8.0; //view间隔
...
-(void) setupData{
    ...
    sDROPVIEW_SIZE = ([[UIScreen mainScreen] bounds].size.width - 2*10 - 3*8)/3;
...
- (void) addLastButton
{
    ...
    if (!_o_addButton) {
        ...
        [addButton setImage:[UIImage imageNamed:@"bg_add_imgshow.png"] forState:UIControlStateNormal];
