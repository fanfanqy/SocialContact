...
- (UIImageView *)menuContainerView {
    if (!_menuContainerView) {
        //[UIColor whiteColor]
        _menuContainerView = [[UIImageView alloc] initWithImage:[[UIImage imageWithColor:BackGroundColor] resizableImageWithCapInsets:UIEdgeInsetsMake(30, 10, 30, 50) resizingMode:UIImageResizingModeTile]];
