...
@property (nonatomic, strong) UIColor* livenessHomeBackgroundColor;   //  检测页面背景色
@property (nonatomic, strong) UIColor* livenessHomeRingColor;         //  检测页面检测中圆环背景色
@property (nonatomic, strong) UIColor* livenessHomeProcessBarColor;   //  检测页面圆环进度颜色
@property (nonatomic, strong) UIColor* livenessHomeValidationFailProcessBarColor;  //  检测页面检测失败时圆环背景色
@property (nonatomic, strong) UIColor* livenessHomePromptColor;       //  检测页面提示文本字体颜色
@property (nonatomic, assign) CGFloat livenessHomePromptSize;         //  检测页面提示文本字体大小
