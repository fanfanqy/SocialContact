...
- (void) setup {
    ...
    _label_tip.font = [UIFont fontWithName:@"Heiti SC" size:15];
	...
	leftView.text = @"   中国(86)";
	leftView.font = [UIFont fontWithName:@"Heiti SC" size:15];
	...
	_field_mobile.font = [UIFont fontWithName:@"Heiti SC" size:15];
	...
	_button_nextStep.titleLabel.font = [UIFont fontWithName:@"Heiti SC" size:16];
